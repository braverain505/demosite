...
window.EIS_DATA = {
  ...
  news: [
    ...
    { id: 'parent-forum', tag: 'Community', title: 'Parents’ Forum elects the 2026/27 liaison team', date: '2026-06-02', lead: 'The Forum again elected representatives to champion welfare, safeguarding and healthy school-home communication this session.', img: 'forum' },
    { id: 'sports-day', tag: 'Sports', title: 'Sports day prize-giving crowns a lively inter-house week', date: '2026-05-24', lead: 'Houses battled across sprint, relay and field events before a full stand of cheering parents.', img: 'sports' },
  ...
  events: [
    ...
    { date: '2026-10-23', title: 'Inter-house debate finals', tag: 'Student life' },
  ...
  programmes: [
    { id: 'nursery', stage: 'Nursery & Early Years', ages: 'Ages 2–5', blurb: 'A warm, language-rich start where play and structure meet. Early literacy, numeracy and social skills are seeded in small, cared-for groups.', tags: ['Early literacy', 'Play-based learning', 'Positive trips'] },
    { id: 'primary', stage: 'Primary · Key Stage 1–2', ages: 'Ages 5–11', blurb: 'The British & Nigerian basics are mastered here — reading, writing, mathematics and science — with a strong moral and citizenship core.', tags: ['KS1–KS2', 'Science labs from Primary', 'Clubs begin'] },
    { id: 'jss', stage: 'Junior Secondary · Key Stage 3', ages: 'Ages 11–14', blurb: 'A broad bridge to the senior years: real subject departments, three science laboratories, leadership opportunities and team sports.', tags: ['KS3', 'Lab practice', 'School Parliament'] },
